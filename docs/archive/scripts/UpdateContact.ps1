...
$content = $content -replace '(?s)<div class="card-grid contact-grid">.*?<div class="card" style="text-align: center;">', "$newCardGrid`n`n        <div class=`"card`" style=`"text-align: center;`">"

[System.IO.File]::WriteAllText("contact.html", $content)
Write-Host "Updated contact.html contact text to SVGs."
